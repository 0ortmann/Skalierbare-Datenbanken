...
\begin{abstract}
	...
	Dieses Review von „Resilient Distributed Datasets: A Fault-tolerant Abstraction for In-memory Cluster Computing“ \cite{spark2012} stellt zunächst die Autoren des Artikels kurz vor und setzt sie in Relation zu dem Thema des Artikels. Es folgt eine knappe inhaltliche Zusammenfassung des Artikels sowie eine kritische Beurteilung.
